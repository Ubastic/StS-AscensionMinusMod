...
public class AscensionPatch {
	...
	public static class IncrementPatch {
		public static SpireReturn<?> Prefix(CharacterOption __instance, @ByRef int[] level) {
			...
			AscensionMinusMod.AbsoluteAscensionLevel = level[0];
	...
	public static class CustomRenderPatch {
		...
		public static void Insert(CustomModeScreen __instance, SpriteBatch sb) {
			AscensionMinusMod.AbsoluteAscensionLevel = __instance.ascensionLevel;
		...
		public static void Postfix(CustomModeScreen __instance, SpriteBatch sb) {
			if (AscensionMinusMod.AbsoluteAscensionLevel >= 0) // don't do anything if asc isn't negative
				return;

			if (AscensionMinusMod.AbsoluteAscensionLevel < AscensionMinusMod.MIN_ASC_LVL) { // asc can't less than min
				AscensionMinusMod.AbsoluteAscensionLevel = AscensionMinusMod.MIN_ASC_LVL;
			}

			__instance.ascensionLevel = AscensionMinusMod.AbsoluteAscensionLevel;
